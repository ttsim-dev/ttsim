...
evaluation_date_str = _dates.evaluation_date_str
evaluation_date_use_other_info = _dates.evaluation_date_use_other_info
policy_date = _dates.policy_date
...
def test_policy_date_invalid_date_raises():
    with pytest.raises(ValueError, match=r"day.*(out of range|must be in range)"):
