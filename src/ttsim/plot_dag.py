...
def plot_dag(
    ...
    processed_functions = with_partialled_params_and_scalars(
        specialized_environment__with_processed_params_and_scalars=functions_with_rounding_specs,  # noqa: F821
