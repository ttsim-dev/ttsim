...
def erwerbseinkommen_m(
    ...
    arbeitslosengeld_2__regelsatz_nach_regelbedarfsstufen: SGBIIRegelsatzNachRegelbedarfsstufen,
) -> float:
    ...
    earnings_after_max_deduction = (
        earnings - arbeitslosengeld_2__regelsatz_nach_regelbedarfsstufen.rbs_1 / 2
    )
...
def private_rente_betrag_m(
    ...
    upper = arbeitslosengeld_2__regelsatz_nach_regelbedarfsstufen.rbs_1 / 2
