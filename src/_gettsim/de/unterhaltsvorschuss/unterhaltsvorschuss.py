...
from _gettsim.ttsim.aggregation import AggregateByPIDSpec
from _gettsim.ttsim.function_types import policy_function
from _gettsim.ttsim.shared import join_numpy
...
def elternteil_alleinerziehend(
    ...
    familie__alleinerziehend
        See basic input variable :ref:`familie__alleinerziehend`.
