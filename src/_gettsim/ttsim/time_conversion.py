...
from _gettsim.ttsim.function_types import DerivedTimeConversionFunction, PolicyFunction

if TYPE_CHECKING:
    from collections.abc import Callable

    from _gettsim.ttsim.typing import QualNameDataDict, QualNameFunctionsDict
