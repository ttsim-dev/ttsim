...
def midijob_faktor_f_mit_minijob_steuerpauschale_bis_2004(
    ...
    allg_sozialv_beitr = (
        ges_rentenv_params["beitragssatz_jahresanfang"]
        + arbeitslosenversicherung_params["beitragssatz_jahresanfang"]
        + ges_pflegev_params["beitragssatz_jahresanfang"]
    )
...
def midijob_faktor_f_mit_minijob_steuerpauschale_ab_2005_bis_2022_09(
    ...
    allg_sozialv_beitr = (
        ges_rentenv_params["beitragssatz_jahresanfang"]
        + arbeitslosenversicherung_params["beitragssatz_jahresanfang"]
        + ges_pflegev_params["beitragssatz_jahresanfang"]["standard"]
    )
