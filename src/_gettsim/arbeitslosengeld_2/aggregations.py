...
def anzahl_kinder_fg(
    familie__ist_kind_in_familiengemeinschaft: bool, fg_id: int
) -> int:
    pass


@agg_by_group_function(start_date="2005-01-01", agg_type=AggType.SUM)
def anzahl_kinder_bis_6_fg(familie__kind_in_fg_bis_6: bool, fg_id: int) -> int:
    pass


@agg_by_group_function(start_date="2005-01-01", agg_type=AggType.SUM)
def anzahl_kinder_bis_15_fg(familie__kind_in_fg_bis_15: bool, fg_id: int) -> int:
    pass


@agg_by_group_function(start_date="2005-01-01", agg_type=AggType.SUM)
def anzahl_kinder_bis_17_fg(familie__kind_in_fg_bis_17: bool, fg_id: int) -> int:
    pass
