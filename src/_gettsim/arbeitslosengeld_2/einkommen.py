...
def bruttoeinkommen_m(  # noqa: PLR0913
    ...
    einkommensteuer__einkünfte__sonstige__sonstige_einkünfte_ohne_renten_m
        See basic input variable :ref:`einkommensteuer__einkünfte__sonstige__sonstige_einkünfte_ohne_renten_m <einkommensteuer__einkünfte__sonstige__sonstige_einkünfte_ohne_renten_m>`.
